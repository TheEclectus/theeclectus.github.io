...
var Game = function() {
  var [stratagem, setStratagem] = import_react2.useState(null);
  var [entered, setEnteredArrows] = import_react2.useState([]);
  var [gameState, setGameState] = import_react2.useState(GameState.Playing);
  var [history, setHistory] = import_react2.useState([]);
  var baseRef = import_react2.useRef(null);
  ...
  function keyDown(event) {
    function appendHistory(stratagem2, success) {
      var newHistory = {
    ...
    children: [
            ...
            children: jsx_dev_runtime.jsxDEV("div", {
              children: [
                jsx_dev_runtime.jsxDEV("div", {
                  ...
                  "data-show": playing,
                  children: gameState == GameState.Won ? "Success!" : gameState == GameState.Lost ? "Failure" : " "
                }, undefined, false, undefined, this),
                jsx_dev_runtime.jsxDEV("div", {
                  className: "stratagem-label",
                  "data-highlight": won,
          ...
          jsx_dev_runtime.jsxDEV("div", {
            ...
            children: [
              jsx_dev_runtime.jsxDEV("div", {
                className: "game-box",
                "data-failed": lost,
                children: stratagem?.arrows.map((val, idx) => {
                  var direction = ArrowDirection[val].toLowerCase();
              ...
              jsx_dev_runtime.jsxDEV("div", {
                ...
                "data-flash": playing,
                children: gameState != GameState.Playing ? "Press space to continue." : " "
              }, undefined, false, undefined, this)
            ]
          }, undefined, true, undefined, this)
        ]
      ...
      jsx_dev_runtime.jsxDEV("div", {
        ...
        children: jsx_dev_runtime.jsxDEV("div", {
          ...
          children: history?.map((histStrat, idx) => {
            return jsx_dev_runtime.jsxDEV("div", {
              className: "history-item",
              children: jsx_dev_runtime.jsxDEV("img", {
                className: "history",
                "data-failed": histStrat.success ? null : true,
                src: "./svgicons/" + histStrat.stratagem.icon
              }, undefined, false, undefined, this)
            }, idx, false, undefined, this);
          })
        }, undefined, false, undefined, this)
      ...
      jsx_dev_runtime.jsxDEV("div", {
        ...
        children: [
          ...
          jsx_dev_runtime.jsxDEV("div", {
            children: "Helldivers 2 copyright Arrowhead Studio and Sony Entertainment"
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this)
    ]
...
(function(ArrowDirection2) {
  ...
  ArrowDirection2[ArrowDirection2["Down"] = 2] = "Down";
  ArrowDirection2[ArrowDirection2["Left"] = 3] = "Left";
  ArrowDirection2[ArrowDirection2["Right"] = 4] = "Right";
})(ArrowDirection || (ArrowDirection = {}));
var InGameStrategems = null;
var RawInGameStratagems = [
...
document.addEventListener("DOMContentLoaded", async () => {
  await LoadIcons();
  var root = client.createRoot(document.querySelector("div#game"));
  root.render(jsx_dev_runtime.jsxDEV(Game, {}, undefined, false, undefined, this));
});
var GameState;
(function(GameState2) {
